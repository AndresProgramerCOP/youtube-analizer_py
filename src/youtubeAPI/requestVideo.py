...
def storage_to_json_file(data):
    ...
    fused_data = data
    a = input("selecciona el nombre para el archivo: ")
    filename = f'output\{a}.json' #Quiero hacer que el nombrado del archivo JSON sea dinamico, es decir que se obyenga o se ponga el nombre segun el titulo del video y del canala por el cual estoy extrayendo los datos
